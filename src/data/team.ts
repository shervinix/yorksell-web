...
export interface TeamMember {
  ...
  image: string;
  /** Optional utility classes for per-member image framing tweaks */
...
export const teamMembers: TeamMember[] = [
  {
    ...
    image: "/images/team/varshokar.jpg",
    imageClassName: "scale-105 translate-y-2",
  ...
  },
  {
    ...
    role: "Realtor®",
    image: "/images/team/ersozoglu.jpg",
    imageClassName: "scale-105 translate-y-2",
